...
const captions = [
    {
        ...
        description: "Solitude of scenery"
    },
    {
        location: "Bora Bora",
        description: "Destination of desire"
    },
    {
        location: "Sahara, Egypt",
        description: "Epitome of Arabia"
    },
    {
        location: "Kauai, Hawaii",
        description: "Captivating Horizons"
    },
    {
        location: "Isle of Skyes, Scotland",
        description: "Immersive abyss"
    },
    {
        location: "Antalya, Turkey",
        description: "Abode of tranquility"
    },
    // Add new captions
    {
            ...
            <div className='explore-container' style={{ backgroundImage: `url(${backgroundImage})` }}>
                <div className='explore-content'>
                    ...
                    <div className='explore'>
                        {[explores_1, explores_2, explores_3, explores_4, explores_5, explores_6, explores_7, explores_8, explores_9, explores_10, explores_11, explores_12].map((image, index) => (
